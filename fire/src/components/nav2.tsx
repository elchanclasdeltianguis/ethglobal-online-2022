...
export default function Nav2(props: Nav2Interface) {
  return (
    <>
      {props.type === 'TYPE0' && (
        <div className="absolute top-[0] left-[calc(50%_-_470px_+_0px)] inline-flex w-[940px] items-center justify-between bg-white pt-[30px] pb-[30px] text-center font-['Roboto'] text-xl font-bold leading-[30px] text-white [backdrop-filter:blur(4px)]">
